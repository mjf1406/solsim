    ...
    <div className="mx-auto max-w-4xl space-y-10 p-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          <code className="text-foreground">2 × mean_radius_km</code>.
          Dwarf planets: five largest in this dataset by that diameter. Moons:
          five largest per planet or dwarf planet.
        </p>
      </header>
