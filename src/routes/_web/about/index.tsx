    ...
    <article className="mx-auto w-full max-w-3xl px-6 pt-6 pb-14 lg:px-8">
      ...
      <div className="space-y-10">
        <section id="objective" className="scroll-mt-28 space-y-3">
          ...
          <p className="leading-relaxed text-muted-foreground">
            One day, when I was brainstorming ideas to enhance the education of
            my students in regards to the Solar System, the basic idea of this
            site popped into my head. The{" "}
            <a
            ...
            missing so much. This site tries to provide the &quot;so much&quot;
            that it is missing for the students at a level that is accessible to
            them.
          </p>
          <p className="leading-relaxed text-muted-foreground">
            It&apos;s inspired by{" "}
            ...
            example, let&apos;s say we have a student named Kelly. She opens the
            Solar System simulation after being explicitly taught the
            aforementioned simplified model. She notices all of the comets,
            asteroids, dwarf planets, and moons that she didn&apos;t learn about
            before. She is freely able to click on them to learn more about
            them!
          </p>
          <p className="leading-relaxed text-muted-foreground">
            ...
            next reading level to see what else she learned, whether that&apos;s
            new words, new concepts, or simply more detailed information. She
            can continue to explore the simulation at her own pace, and she can
            even share what she learned with her classmates!
          </p>
        </section>
        ...
        <section id="methods" className="scroll-mt-28 space-y-3">
          ...
          <div className="space-y-3 leading-relaxed text-muted-foreground">
            <p>
              ...
              Keplerian orbits are not the most accurate methdod for displaying
              orbits, they are good enough for NASA for the{" "}
              <a
            ...
            <ul className="list-inside list-disc space-y-1 pl-1">
              ...
              <li>
                the four hundred fifty-three (453) natural satellites of all the
                planets and dwarf planets that are available in the Horizons
                system,
              </li>
              <li>
          ...
          <div className="space-y-3 leading-relaxed text-muted-foreground">
            <p>
              ...
              ensure they could use it in class to explore how the Solar System
              looks and works after learning the standard educational model, so
              I used AI to help me make this more quickly.
            </p>
            <p>
