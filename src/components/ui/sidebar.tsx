  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "[--sidebar-width:16rem] group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]:bg-sidebar-surface",
          className
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          /* Below fixed header + gap; header slot portals are unchanged (mount nodes live in AppHeader). */
          "fixed top-[calc(var(--app-header-h)+var(--sidebar-gap-below-app-header))] bottom-(--sidebar-gap-below-app-header) z-10 hidden w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:-left-(--sidebar-width) data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:-right-(--sidebar-width) md:flex",
      ...
      >
        <div
          ...
          className={cn(
            "flex size-full flex-col overflow-hidden bg-sidebar-surface",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full hover:group-data-[collapsible=offcanvas]:bg-sidebar-surface",
